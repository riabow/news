...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { d: @price.d, prc: @price.prc, supl_id: @price.supl_id, tov_id: @price.tov_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { d: @price.d, prc: @price.prc, supl_id: @price.supl_id, tov_id: @price.tov_id } }
